...
verifies an existing bundle and writes a human-readable Markdown review report
with source IDs, record roots, control status, source-artifact hashes, and
limitations.

`framework-runtime-service-authority-recorded-export-provider-bundle-extract`
verifies an existing bundle and writes embedded raw JSON source artifacts to
safe reviewer filenames derived from artifact names, not the original source
paths.
...
python -m trustai framework-runtime-service-authority-recorded-export-provider-bundle-render artifacts/framework-runtime-service-authority-recorded-export-provider-bundle.json --out artifacts/framework-runtime-service-authority-recorded-export-provider-bundle.md
python -m trustai framework-runtime-service-authority-recorded-export-provider-bundle-extract artifacts/framework-runtime-service-authority-recorded-export-provider-bundle.json --out-dir artifacts/framework-runtime-service-authority-recorded-export-provider-bundle-sources
