...
- `evidence_hash`: canonical `sha256:` plus 64 lowercase hex characters for the external evidence or immutable root.
...
8. Reject malformed evidence references, non-canonical evidence hashes, and timestamp windows.
