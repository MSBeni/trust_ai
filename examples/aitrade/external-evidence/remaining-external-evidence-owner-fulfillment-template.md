...
- Template ID: `7d262e6618c4c0c11f9a69b4cf780f377174c60d7cb6d6f153f5b174093a11ac`
...
|---|---|---|
| `agent-inventory-and-identity:identity-provider` | TODO://authority/agent-inventory-and-identity/identity-provider | identity-provider evidence for agent-inventory-and-identity |
...
| `runtime-policy-and-attestation:identity-provider` | TODO://authority/runtime-policy-and-attestation/identity-provider | identity-provider evidence for runtime-policy-and-attestation |
...
| `runtime-policy-and-attestation:kms-hsm` | TODO://authority/runtime-policy-and-attestation/kms-hsm | kms-hsm evidence for runtime-policy-and-attestation |
...
|---|---|---|---|---|---|
| `agent-inventory-and-identity:identity-provider` | IAM/identity owner | blocked | `placeholder-source-uri`, `missing-intake` | artifacts/external-evidence-sources/agent-inventory-and-identity/identity-provider.json | artifacts/external-evidence-intakes/agent-inventory-and-identity/identity-provider.json |
...
| `runtime-policy-and-attestation:identity-provider` | IAM/identity owner | blocked | `placeholder-source-uri`, `missing-intake` | artifacts/external-evidence-sources/runtime-policy-and-attestation/identity-provider.json | artifacts/external-evidence-intakes/runtime-policy-and-attestation/identity-provider.json |
...
| `runtime-policy-and-attestation:kms-hsm` | security/platform KMS owner | blocked | `placeholder-source-uri`, `missing-intake` | artifacts/external-evidence-sources/runtime-policy-and-attestation/kms-hsm.json | artifacts/external-evidence-intakes/runtime-policy-and-attestation/kms-hsm.json |
