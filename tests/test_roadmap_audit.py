...
class RoadmapAuditTests(unittest.TestCase):
    def test_roadmap_audit_hashes_local_evidence_and_verifies(self):
        ...
        self.assertIn("docs/specs/promotion-status-review-bundle-v0.1.md", cicd_evidence)
        ...
        self.assertIn("tests/test_provider_delivery.py", cicd_evidence)
        self.assertIn("tests/test_provider_delivery_worker_bundle.py", cicd_evidence)
        self.assertIn("tests/test_promotion_status_bundle.py", cicd_evidence)
        ...
        self.assertIn("worker review bundles replay", cicd_external_authority)
        self.assertIn("promotion status review bundles embed", cicd_external_authority)
