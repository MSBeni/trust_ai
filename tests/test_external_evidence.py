...
from trustai.external_evidence import (
    ...
    render_external_evidence_production_replacement_submission_markdown,
    ...
    render_external_evidence_production_replacement_remediation_owner_fulfillment_review_markdown,
    render_external_evidence_production_replacement_remediation_application_markdown,
...
class ExternalEvidenceManifestTests(unittest.TestCase):
    ...
    def test_external_evidence_production_replacement_plan_exports_non_production_tasks(self):
        ...
        plan = build_external_evidence_collection_plan(manifest, audit, root=ROOT, status_filter="missing", generated_at="2026-07-09T00:00:00Z")
        plan_all = build_external_evidence_collection_plan(manifest, audit, root=ROOT, status_filter="all", generated_at="2026-07-09T00:00:30Z")
        ...
        intake_template = build_external_evidence_production_replacement_intake_template(
            owner_packet_status,
            generated_at="2026-07-09T00:08:00Z",
        )
        intake_template_result = verify_external_evidence_production_replacement_intake_template(intake_template, owner_packet_status)
        intake_template_markdown = render_external_evidence_production_replacement_intake_template_markdown(intake_template)
        live_fulfillment = {
            "task": "oss-verifier-and-public-spec:ci-run",
            "source_uri": "https://github.com/MSBeni/trust_ai/actions/runs/1234567890",
            "description": "Live GitHub Actions production authority run for the public verifier release workflow.",
            "source_file": "external-evidence/production/oss-verifier-and-public-spec/ci-run.json",
            "retrieval_method": "authority-export",
            "content_type": "application/json",
            "issuer": "GitHub Actions",
            "subject": "MSBeni/trust_ai verifier release workflow production run",
            "issued_at": "2026-07-09T00:08:30Z",
            "expires_at": "2026-12-31T00:00:00Z",
        }
        replacement_submission = build_external_evidence_production_replacement_submission(
            intake_template,
            [live_fulfillment],
            generated_at="2026-07-09T00:08:30Z",
        )
        replacement_submission_result = verify_external_evidence_production_replacement_submission(
            replacement_submission,
            intake_template,
            require_submitted_live_source_uris=True,
        )
        replacement_submission_markdown = render_external_evidence_production_replacement_submission_markdown(replacement_submission)
        submitted_template = replacement_submission["submitted_template"]
        submitted_review = build_external_evidence_production_replacement_submission_review(
            submitted_template,
            owner_packet_status,
            plan_all,
            root=ROOT,
            require_live_source_uris=True,
            generated_at="2026-07-09T00:08:45Z",
        )
        submitted_review_result = verify_external_evidence_production_replacement_submission_review(
            submitted_review,
            submitted_template,
            owner_packet_status,
            plan_all,
        ...
        submission_review = build_external_evidence_production_replacement_submission_review(
            intake_template,
            owner_packet_status,
            plan_all,
            root=ROOT,
        ...
        submission_review_result = verify_external_evidence_production_replacement_submission_review(
            submission_review,
            intake_template,
            owner_packet_status,
            plan_all,
        ...
        clear_remediation_queue = build_external_evidence_production_replacement_remediation_queue(
            submitted_review,
            generated_at="2026-07-09T00:08:50Z",
        )
        clear_remediation_queue_result = verify_external_evidence_production_replacement_remediation_queue(
            clear_remediation_queue,
            submitted_review,
            require_empty=True,
        )
        remediation_queue = build_external_evidence_production_replacement_remediation_queue(
            submission_review,
            generated_at="2026-07-09T00:09:05Z",
        )
        remediation_queue_result = verify_external_evidence_production_replacement_remediation_queue(
            remediation_queue,
            submission_review,
        )
        strict_remediation_queue_result = verify_external_evidence_production_replacement_remediation_queue(
            remediation_queue,
            submission_review,
            require_empty=True,
        )
        remediation_queue_markdown = render_external_evidence_production_replacement_remediation_queue_markdown(remediation_queue)
        remediation_owner_packets = build_external_evidence_production_replacement_remediation_owner_packets(
            remediation_queue,
            generated_at="2026-07-09T00:09:10Z",
        )
        remediation_owner_packets_result = verify_external_evidence_production_replacement_remediation_owner_packets(
        ...
        remediation_owner_fulfillment_review = build_external_evidence_production_replacement_remediation_owner_fulfillment_review(
            remediation_owner_fulfillment_template,
            remediation_owner_packets,
            plan_all,
            root=ROOT,
            require_live_source_uris=True,
            generated_at="2026-07-09T00:09:13Z",
        )
        remediation_owner_fulfillment_review_result = verify_external_evidence_production_replacement_remediation_owner_fulfillment_review(
        ...
        strict_remediation_owner_fulfillment_review_result = verify_external_evidence_production_replacement_remediation_owner_fulfillment_review(
            remediation_owner_fulfillment_review,
            remediation_owner_fulfillment_template,
            remediation_owner_packets,
            plan_all,
        ...
        remediation_owner_fulfillment_review_markdown = render_external_evidence_production_replacement_remediation_owner_fulfillment_review_markdown(
            remediation_owner_fulfillment_review
        )
        live_remediation_owner_fulfillment_template = copy.deepcopy(remediation_owner_fulfillment_template)
        live_remediation_owner_fulfillment_template["fulfillments"][0].update(live_fulfillment)
        live_remediation_owner_fulfillment_review = build_external_evidence_production_replacement_remediation_owner_fulfillment_review(
            live_remediation_owner_fulfillment_template,
            remediation_owner_packets,
            plan_all,
            root=ROOT,
            require_live_source_uris=True,
            generated_at="2026-07-09T00:09:14Z",
        )
        live_remediation_owner_fulfillment_review_result = verify_external_evidence_production_replacement_remediation_owner_fulfillment_review(
            live_remediation_owner_fulfillment_review,
            live_remediation_owner_fulfillment_template,
            remediation_owner_packets,
            plan_all,
            root=ROOT,
        ...
        remediation_application = build_external_evidence_production_replacement_remediation_application(
            submission_review,
            remediation_owner_fulfillment_review,
            generated_at="2026-07-09T00:09:14Z",
        )
        remediation_application_result = verify_external_evidence_production_replacement_remediation_application(
            remediation_application,
            submission_review,
            remediation_owner_fulfillment_review,
        )
        strict_remediation_application_result = verify_external_evidence_production_replacement_remediation_application(
            remediation_application,
            submission_review,
            remediation_owner_fulfillment_review,
            require_ready=True,
        )
        remediation_application_markdown = render_external_evidence_production_replacement_remediation_application_markdown(
            remediation_application
        )
        live_remediation_application = build_external_evidence_production_replacement_remediation_application(
            submission_review,
            live_remediation_owner_fulfillment_review,
            generated_at="2026-07-09T00:09:15Z",
        )
        live_remediation_application_result = verify_external_evidence_production_replacement_remediation_application(
            live_remediation_application,
            submission_review,
            live_remediation_owner_fulfillment_review,
            require_ready=True,
        )
        applied_submission_review = live_remediation_application["applied_submission_review"]
        applied_collection_package = build_external_evidence_production_replacement_collection_package(
            applied_submission_review,
            manifest,
            audit,
            root=ROOT,
            generated_at="2026-07-09T00:09:16Z",
        )
        applied_collection_package_result = verify_external_evidence_production_replacement_collection_package(
            applied_collection_package,
            applied_submission_review,
            manifest,
            audit,
            root=ROOT,
        ...
        self.assertEqual(EXTERNAL_EVIDENCE_PRODUCTION_REPLACEMENT_SUBMISSION_SCHEMA, replacement_submission["schema"])
        self.assertEqual(EXTERNAL_EVIDENCE_PRODUCTION_REPLACEMENT_SUBMISSION_REVIEW_SCHEMA, submitted_review["schema"])
        ...
        self.assertEqual(EXTERNAL_EVIDENCE_PRODUCTION_REPLACEMENT_REMEDIATION_OWNER_FULFILLMENT_REVIEW_SCHEMA, remediation_owner_fulfillment_review["schema"])
        self.assertEqual(EXTERNAL_EVIDENCE_PRODUCTION_REPLACEMENT_REMEDIATION_APPLICATION_SCHEMA, remediation_application["schema"])
        ...
        self.assertTrue(replacement_submission_result.ok, replacement_submission_result.errors)
        self.assertTrue(submitted_review_result.ok, submitted_review_result.errors)
        ...
        self.assertTrue(remediation_owner_fulfillment_review_result.ok, remediation_owner_fulfillment_review_result.errors)
        self.assertFalse(strict_remediation_owner_fulfillment_review_result.ok)
        self.assertTrue(live_remediation_owner_fulfillment_review_result.ok, live_remediation_owner_fulfillment_review_result.errors)
        self.assertTrue(remediation_application_result.ok, remediation_application_result.errors)
        self.assertFalse(strict_remediation_application_result.ok)
        self.assertTrue(live_remediation_application_result.ok, live_remediation_application_result.errors)
        self.assertTrue(applied_collection_package_result.ok, applied_collection_package_result.errors)
        ...
        self.assertEqual(1, intake_template["summary"]["request_count"])
        self.assertEqual(1, intake_template["summary"]["fulfillment_count"])
        self.assertEqual(1, intake_template["summary"]["placeholder_source_uri_count"])
        self.assertEqual("oss-verifier-and-public-spec:ci-run", intake_template["fulfillments"][0]["task"])
        self.assertEqual("TODO://production-authority/oss-verifier-and-public-spec/ci-run", intake_template["fulfillments"][0]["source_uri"])
        self.assertEqual(FIXTURE, intake_template["requests"][0]["replaces_artifacts"][0])
        self.assertEqual(1, replacement_submission["summary"]["submitted_task_count"])
        self.assertEqual(1, replacement_submission["summary"]["submitted_live_source_uri_count"])
        self.assertEqual(0, replacement_submission["summary"]["submitted_placeholder_source_uri_count"])
        self.assertEqual(0, replacement_submission["summary"]["placeholder_source_uri_count"])
        self.assertEqual(live_fulfillment["source_uri"], submitted_template["fulfillments"][0]["source_uri"])
        self.assertEqual(live_fulfillment["source_uri"], submitted_template["requests"][0]["fulfillment"]["source_uri"])
        self.assertEqual("ready-to-collect", submitted_review["summary"]["review_status"])
        self.assertEqual(1, submitted_review["summary"]["ready_task_count"])
        self.assertEqual(0, submitted_review["summary"]["blocked_task_count"])
        self.assertEqual(0, submitted_review["summary"]["placeholder_source_uri_count"])
        self.assertEqual(1, submitted_review["summary"]["live_source_uri_count"])
        self.assertEqual("blocked", submission_review["summary"]["review_status"])
        self.assertEqual(0, submission_review["summary"]["ready_task_count"])
        self.assertEqual(1, submission_review["summary"]["blocked_task_count"])
        self.assertEqual(1, submission_review["summary"]["placeholder_source_uri_count"])
        ...
        self.assertEqual("clear", clear_remediation_queue["summary"]["queue_status"])
        self.assertEqual(0, clear_remediation_queue["summary"]["remediation_task_count"])
        self.assertEqual("blocked", remediation_queue["summary"]["queue_status"])
        self.assertEqual(1, remediation_queue["summary"]["remediation_task_count"])
        self.assertEqual(1, remediation_queue["summary"]["placeholder_source_uri_count"])
        self.assertEqual({"release engineering": 1}, remediation_queue["summary"]["remediation_count_by_owner_hint"])
        self.assertEqual({"ci-run": 1}, remediation_queue["summary"]["remediation_count_by_authority_kind"])
        self.assertEqual({"placeholder-source-uri": 1}, remediation_queue["summary"]["remediation_count_by_blocking_reason"])
        self.assertEqual("placeholder-source-uri", remediation_queue["remediation_items"][0]["blocking_reasons"][0])
        self.assertEqual("REPLACE_WITH_LIVE_AUTHORITY_URI", remediation_queue["remediation_items"][0]["fulfillment_template"]["source_uri"])
        self.assertIn("replace source_uri", remediation_queue["remediation_items"][0]["remediation_action"])
        self.assertEqual("blocked", remediation_owner_packets["summary"]["queue_status"])
        self.assertEqual(1, remediation_owner_packets["summary"]["packet_count"])
        self.assertEqual(1, remediation_owner_packets["summary"]["owner_count"])
        self.assertEqual(1, remediation_owner_packets["summary"]["remediation_task_count"])
        self.assertEqual(1, remediation_owner_packets["summary"]["blocked_task_count"])
        ...
        self.assertEqual("blocked", remediation_owner_fulfillment_review["summary"]["review_status"])
        self.assertEqual(0, remediation_owner_fulfillment_review["summary"]["ready_task_count"])
        self.assertEqual(1, remediation_owner_fulfillment_review["summary"]["blocked_task_count"])
        self.assertEqual(1, remediation_owner_fulfillment_review["summary"]["placeholder_source_uri_count"])
        self.assertEqual(0, remediation_owner_fulfillment_review["summary"]["live_source_uri_count"])
        self.assertEqual("ready-to-collect", live_remediation_owner_fulfillment_review["summary"]["review_status"])
        self.assertEqual("blocked", remediation_application["summary"]["application_status"])
        self.assertEqual("blocked", remediation_application["summary"]["applied_review_status"])
        self.assertEqual(1, remediation_application["summary"]["applied_task_count"])
        self.assertEqual(1, remediation_application["summary"]["blocked_task_count"])
        self.assertEqual(1, remediation_application["summary"]["placeholder_source_uri_count"])
        self.assertEqual("ready-to-collect", live_remediation_application["summary"]["application_status"])
        self.assertEqual("ready-to-collect", live_remediation_application["summary"]["applied_review_status"])
        self.assertEqual("ready-to-collect", applied_submission_review["summary"]["review_status"])
        self.assertEqual(0, applied_submission_review["summary"]["placeholder_source_uri_count"])
        self.assertEqual(1, applied_submission_review["summary"]["live_source_uri_count"])
        self.assertEqual("ready-to-collect", applied_collection_package["summary"]["collection_status"])
        self.assertEqual(1, applied_collection_package["summary"]["ready_task_count"])
        self.assertEqual(0, applied_collection_package["summary"]["blocked_task_count"])
        ...
        self.assertEqual(
            content_hash(without_keys(remediation_owner_packets["packets"][0], "packet_id")),
            remediation_owner_packets["packets"][0]["packet_id"],
        )
        self.assertEqual(
            "REPLACE_WITH_LIVE_AUTHORITY_URI",
            remediation_owner_packets["packets"][0]["fulfillment_templates"][0]["source_uri"],
        )
        ...
        self.assertIn("External Evidence Production Replacement Intake Template", intake_template_markdown)
        self.assertIn("Requests: 1", intake_template_markdown)
        self.assertIn("External Evidence Production Replacement Submission", replacement_submission_markdown)
        self.assertIn("Submitted tasks: 1", replacement_submission_markdown)
        ...
        self.assertIn("External Evidence Production Replacement Remediation Queue", remediation_queue_markdown)
        self.assertIn("Remediation tasks: 1", remediation_queue_markdown)
        self.assertIn("placeholder-source-uri", remediation_queue_markdown)
        self.assertIn("External Evidence Production Replacement Remediation Owner Packets", remediation_owner_packets_markdown)
        self.assertIn("Remediation tasks: 1", remediation_owner_packets_markdown)
        self.assertIn("release engineering", remediation_owner_packets_markdown)
        self.assertIn("External Evidence Production Replacement Remediation Application", remediation_application_markdown)
        self.assertIn("Blocked tasks: 1", remediation_application_markdown)
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            intake_template_path = tmp_path / "replacement-intake-template.json"
            intake_template_markdown_path = tmp_path / "replacement-intake-template.md"
            submission_path = tmp_path / "replacement-submission.json"
            submission_markdown_path = tmp_path / "replacement-submission.md"
            submitted_template_path = tmp_path / "replacement-submitted-template.json"
            submitted_review_path = tmp_path / "replacement-submitted-review.json"
            ...
            remediation_queue_path = tmp_path / "replacement-remediation-queue.json"
            ...
            remediation_application_path = tmp_path / "replacement-remediation-application.json"
            remediation_application_markdown_path = tmp_path / "replacement-remediation-application.md"
            applied_review_path = tmp_path / "replacement-remediation-applied-review.json"
            ...
            write_roadmap_audit(audit_path, audit)
            write_external_evidence_manifest(manifest_path, manifest)
            write_external_evidence_collection_plan(plan_all_path, plan_all)
            ...
            subprocess.run(
                [
                    ...
                    "--markdown",
                    str(intake_template_markdown_path),
                ],
                cwd=ROOT,
                check=True,
            )
            cli_intake_template = load_external_evidence_production_replacement_intake_template(intake_template_path)
            self.assertEqual(intake_template, cli_intake_template)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            subprocess.run(
                [
                    ...
                    str(intake_template_path),
                    "--fulfillment",
                    "oss-verifier-and-public-spec:ci-run;source_uri=https://github.com/MSBeni/trust_ai/actions/runs/1234567890;description=Live GitHub Actions production authority run for the public verifier release workflow.;source_file=external-evidence/production/oss-verifier-and-public-spec/ci-run.json;retrieval_method=authority-export;content_type=application/json;issuer=GitHub Actions;subject=MSBeni/trust_ai verifier release workflow production run;issued_at=2026-07-09T00:08:30Z;expires_at=2026-12-31T00:00:00Z",
                    ...
                    str(submission_path),
                    "--markdown",
                    str(submission_markdown_path),
                    "--submitted-template-out",
                    str(submitted_template_path),
                ],
                cwd=ROOT,
                check=True,
            )
            cli_submission = load_external_evidence_production_replacement_submission(submission_path)
            self.assertEqual(replacement_submission, cli_submission)
            self.assertEqual(submitted_template, load_external_evidence_production_replacement_intake_template(submitted_template_path))
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            subprocess.run(
                [
                    ...
                    "--require-ready",
                    "--generated-at",
                    "2026-07-09T00:08:45Z",
                    "--out",
                    str(submitted_review_path),
                ],
                cwd=ROOT,
                check=True,
            )
            self.assertEqual(submitted_review, load_external_evidence_production_replacement_submission_review(submitted_review_path))
            subprocess.run(
                [
                    sys.executable,
                    "-m",
                    ...
                    "--require-live-source-uris",
                    "--generated-at",
                    "2026-07-09T00:09:00Z",
                    "--out",
                    str(submission_review_path),
                    "--markdown",
                    str(submission_review_markdown_path),
                    "--fulfilled-source-map-out",
                    str(fulfilled_source_map_path),
                ],
                cwd=ROOT,
            ...
            cli_submission_review = load_external_evidence_production_replacement_submission_review(submission_review_path)
            self.assertEqual(submission_review, cli_submission_review)
            cli_fulfilled_source_map = json.loads(fulfilled_source_map_path.read_text(encoding="utf-8"))
            self.assertEqual(submission_review["fulfilled_source_map"], cli_fulfilled_source_map)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            subprocess.run(
                [
                    ...
                    str(submission_review_path),
                    "--generated-at",
                    "2026-07-09T00:09:05Z",
                    "--out",
                    str(remediation_queue_path),
                    "--markdown",
                    str(remediation_queue_markdown_path),
                ],
                cwd=ROOT,
                check=True,
            )
            cli_remediation_queue = load_external_evidence_production_replacement_remediation_queue(remediation_queue_path)
            self.assertEqual(remediation_queue, cli_remediation_queue)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            queue_not_empty = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "trustai",
            ...
            self.assertNotEqual(0, queue_not_empty.returncode)
            self.assertIn("not empty", queue_not_empty.stderr)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
                    ...
                    "--markdown",
                    str(remediation_owner_packets_markdown_path),
                ],
                cwd=ROOT,
                check=True,
            )
            cli_remediation_owner_packets = load_external_evidence_production_replacement_remediation_owner_packets(
                remediation_owner_packets_path
            )
            self.assertEqual(remediation_owner_packets, cli_remediation_owner_packets)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            subprocess.run(
                [
                    ...
                    "--require-live-source-uris",
                    "--generated-at",
                    "2026-07-09T00:09:13Z",
                    "--out",
                    str(remediation_owner_fulfillment_review_path),
                    "--markdown",
                    str(remediation_owner_fulfillment_review_markdown_path),
                    "--fulfilled-source-map-out",
                    str(remediation_owner_fulfillment_review_source_map_path),
                ],
                cwd=ROOT,
                check=True,
            )
            cli_remediation_owner_fulfillment_review = load_external_evidence_production_replacement_remediation_owner_fulfillment_review(
                remediation_owner_fulfillment_review_path
            )
            self.assertEqual(remediation_owner_fulfillment_review, cli_remediation_owner_fulfillment_review)
            cli_remediation_owner_fulfillment_review_source_map = json.loads(
                remediation_owner_fulfillment_review_source_map_path.read_text(encoding="utf-8")
            )
            self.assertEqual(remediation_owner_fulfillment_review["fulfilled_source_map"], cli_remediation_owner_fulfillment_review_source_map)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
            ...
            owner_review_not_ready = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "trustai",
            ...
            self.assertNotEqual(0, owner_review_not_ready.returncode)
            self.assertIn("not ready to collect", owner_review_not_ready.stderr)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "trustai",
                    "external-evidence-production-replacement-remediation-apply",
                    str(submission_review_path),
                    str(remediation_owner_fulfillment_review_path),
                    "--generated-at",
                    "2026-07-09T00:09:14Z",
                    "--out",
                    str(remediation_application_path),
                    "--markdown",
                    str(remediation_application_markdown_path),
                    "--applied-review-out",
            ...
            cli_remediation_application = load_external_evidence_production_replacement_remediation_application(
                remediation_application_path
            )
            self.assertEqual(remediation_application, cli_remediation_application)
            self.assertEqual(
                remediation_application["applied_submission_review"],
                json.loads(applied_review_path.read_text(encoding="utf-8")),
            )
            subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "trustai",
                    "external-evidence-production-replacement-remediation-apply-verify",
                    str(remediation_application_path),
                    str(submission_review_path),
                    str(remediation_owner_fulfillment_review_path),
                ],
            ...
            application_not_ready = subprocess.run(
                [
                    sys.executable,
                    "-m",
                    "trustai",
            ...
            self.assertNotEqual(0, application_not_ready.returncode)
            self.assertIn("not ready to collect", application_not_ready.stderr)
            subprocess.run(
                [
                    sys.executable,
                    "-m",
    ...
    def test_retained_external_evidence_readiness_keeps_reference_exports_not_ready(self):
        ...
        source_plan_all = load_external_evidence_collection_plan(ROOT / "examples/aitrade/external-evidence/source-external-evidence-plan-all.json")
        ...
        replacement_submission = load_external_evidence_production_replacement_submission(ROOT / "examples/aitrade/external-evidence/retained-external-evidence-production-replacement-submission.json")
        ...
        replacement_intake_template_result = verify_external_evidence_production_replacement_intake_template(
            replacement_intake_template,
            replacement_owner_packet_status,
        )
        replacement_submission_result = verify_external_evidence_production_replacement_submission(
            replacement_submission,
        ...
        replacement_submission_review_result = verify_external_evidence_production_replacement_submission_review(
            replacement_submission_review,
            replacement_submitted_template,
            replacement_owner_packet_status,
            source_plan_all,
            root=ROOT,
            require_live_source_uris=True,
        )
        replacement_remediation_application_result = verify_external_evidence_production_replacement_remediation_application(
            replacement_remediation_application,
            replacement_submission_review,
            replacement_remediation_owner_fulfillment_review,
        )
        ...
        replacement_closure_result = verify_external_evidence_production_replacement_closure(
            replacement_closure,
            replacement_applied_submission_review,
            readiness,
        )
        self.assertTrue(replacement_submission_review_result.ok, replacement_submission_review_result.errors)
        self.assertTrue(replacement_remediation_application_result.ok, replacement_remediation_application_result.errors)
        ...
        self.assertEqual(72, replacement_intake_template["summary"]["request_count"])
        self.assertEqual(72, replacement_intake_template["summary"]["fulfillment_count"])
        self.assertEqual(72, replacement_intake_template["summary"]["placeholder_source_uri_count"])
        self.assertEqual(10, replacement_intake_template["summary"]["owner_count"])
        self.assertTrue(all(str(item["source_uri"]).startswith("TODO://production-authority/") for item in replacement_intake_template["fulfillments"]))
        self.assertEqual("blocked", replacement_submission["summary"]["submission_status"])
        self.assertEqual(72, replacement_submission["summary"]["submitted_task_count"])
        self.assertEqual(72, replacement_submission["summary"]["submitted_placeholder_source_uri_count"])
        self.assertEqual(0, replacement_submission["summary"]["submitted_live_source_uri_count"])
        self.assertEqual(72, replacement_submitted_template["summary"]["submitted_task_count"])
        self.assertEqual(72, replacement_submitted_template["summary"]["placeholder_source_uri_count"])
        self.assertEqual("blocked", replacement_submission_review["summary"]["review_status"])
        self.assertEqual(0, replacement_submission_review["summary"]["ready_task_count"])
        self.assertEqual(72, replacement_submission_review["summary"]["blocked_task_count"])
        self.assertEqual(72, replacement_submission_review["summary"]["placeholder_source_uri_count"])
        ...
        self.assertEqual("blocked", replacement_remediation_application["summary"]["application_status"])
        self.assertEqual("blocked", replacement_remediation_application["summary"]["applied_review_status"])
        self.assertEqual(72, replacement_remediation_application["summary"]["applied_task_count"])
        self.assertEqual(72, replacement_applied_submission_review["summary"]["blocked_task_count"])
        self.assertEqual(72, replacement_applied_submission_review["summary"]["placeholder_source_uri_count"])
    ...
    def test_retained_external_evidence_examples_verify(self):
        ...
        design_partner_regulator_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/design-partner-regulator-source-snapshot.json")
        design_partner_insurer_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/design-partner-insurer-source-snapshot.json")
        design_partner_customer_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/design-partner-customer-source-snapshot.json")
        ...
        review_portal_provider_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/review-portal-provider-api-source-snapshot.json")
        review_portal_hosted_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/review-portal-hosted-service-source-snapshot.json")
        review_portal_identity_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/review-portal-identity-provider-source-snapshot.json")
        review_portal_regulator_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/review-portal-regulator-source-snapshot.json")
        ...
        compliance_provider_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/compliance-provider-api-source-snapshot.json")
        ...
        vertical_packs_regulator_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/vertical-packs-regulator-source-snapshot.json")
        ...
        insurer_api_provider_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/insurer-api-actuarial-provider-api-source-snapshot.json")
        insurer_api_hosted_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/insurer-api-actuarial-hosted-service-source-snapshot.json")
        insurer_api_identity_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/insurer-api-actuarial-identity-provider-source-snapshot.json")
        insurer_api_insurer_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/insurer-api-actuarial-insurer-source-snapshot.json")
        insurer_api_customer_snapshot = load_external_evidence_source_snapshot(ROOT / "examples/aitrade/external-evidence/insurer-api-actuarial-customer-source-snapshot.json")
        ...
        design_partner_regulator_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/design-partner-pilot-exit-criteria-regulator.json")
        design_partner_insurer_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/design-partner-pilot-exit-criteria-insurer.json")
        design_partner_customer_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/design-partner-pilot-exit-criteria-customer.json")
        ...
        review_portal_provider_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/auditor-and-review-portal-provider-api.json")
        review_portal_hosted_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/auditor-and-review-portal-hosted-service.json")
        review_portal_identity_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/auditor-and-review-portal-identity-provider.json")
        review_portal_regulator_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/auditor-and-review-portal-regulator.json")
        ...
        compliance_provider_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/compliance-mapper-and-eu-ai-act-provider-api.json")
        ...
        vertical_packs_regulator_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/vertical-packs-regulator.json")
        ...
        insurer_api_provider_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/insurer-api-and-actuarial-products-provider-api.json")
        insurer_api_hosted_intake = load_external_evidence_intake(ROOT / "examples/aitrade/external-evidence/intakes/insurer-api-and-actuarial-products-hosted-service.json")
        ...
        self.assertEqual("examples/aitrade/external-evidence/design-partner-regulator-source-snapshot.json", design_partner_regulator_intake["evidence_item"]["path"])
        self.assertEqual("design-partner-pilot-exit-criteria", design_partner_regulator_intake["task"]["requirement_id"])
        self.assertEqual("regulator", design_partner_regulator_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", design_partner_regulator_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/design-partner-regulator-authority-export.json").read_bytes()).hexdigest(), design_partner_regulator_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/design-partner-insurer-source-snapshot.json", design_partner_insurer_intake["evidence_item"]["path"])
        self.assertEqual("design-partner-pilot-exit-criteria", design_partner_insurer_intake["task"]["requirement_id"])
        self.assertEqual("insurer", design_partner_insurer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", design_partner_insurer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/design-partner-insurer-authority-export.json").read_bytes()).hexdigest(), design_partner_insurer_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/design-partner-customer-source-snapshot.json", design_partner_customer_intake["evidence_item"]["path"])
        self.assertEqual("design-partner-pilot-exit-criteria", design_partner_customer_intake["task"]["requirement_id"])
        self.assertEqual("customer", design_partner_customer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", design_partner_customer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/design-partner-customer-authority-export.json").read_bytes()).hexdigest(), design_partner_customer_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/framework-adapters-ci-run-source-snapshot.json", framework_ci_intake["evidence_item"]["path"])
        self.assertEqual("framework-adapters", framework_ci_intake["task"]["requirement_id"])
        self.assertEqual("ci-run", framework_ci_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", framework_ci_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/framework-adapters-ci-run-authority-export.json").read_bytes()).hexdigest(), framework_ci_snapshot["body_sha256"])
        ...
        self.assertEqual("examples/aitrade/external-evidence/review-portal-provider-api-source-snapshot.json", review_portal_provider_intake["evidence_item"]["path"])
        self.assertEqual("auditor-and-review-portal", review_portal_provider_intake["task"]["requirement_id"])
        self.assertEqual("provider-api", review_portal_provider_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", review_portal_provider_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/review-portal-provider-api-authority-export.json").read_bytes()).hexdigest(), review_portal_provider_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/review-portal-hosted-service-source-snapshot.json", review_portal_hosted_intake["evidence_item"]["path"])
        self.assertEqual("auditor-and-review-portal", review_portal_hosted_intake["task"]["requirement_id"])
        self.assertEqual("hosted-service", review_portal_hosted_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", review_portal_hosted_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/review-portal-hosted-service-authority-export.json").read_bytes()).hexdigest(), review_portal_hosted_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/review-portal-identity-provider-source-snapshot.json", review_portal_identity_intake["evidence_item"]["path"])
        self.assertEqual("auditor-and-review-portal", review_portal_identity_intake["task"]["requirement_id"])
        self.assertEqual("identity-provider", review_portal_identity_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", review_portal_identity_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/review-portal-identity-provider-authority-export.json").read_bytes()).hexdigest(), review_portal_identity_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/review-portal-regulator-source-snapshot.json", review_portal_regulator_intake["evidence_item"]["path"])
        self.assertEqual("auditor-and-review-portal", review_portal_regulator_intake["task"]["requirement_id"])
        self.assertEqual("regulator", review_portal_regulator_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", review_portal_regulator_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/review-portal-regulator-authority-export.json").read_bytes()).hexdigest(), review_portal_regulator_snapshot["body_sha256"])
        ...
        self.assertEqual("examples/aitrade/external-evidence/byoc-ci-run-source-snapshot.json", byoc_ci_intake["evidence_item"]["path"])
        self.assertEqual("byoc-self-hosted", byoc_ci_intake["task"]["requirement_id"])
        self.assertEqual("ci-run", byoc_ci_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", byoc_ci_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/byoc-ci-run-authority-export.json").read_bytes()).hexdigest(), byoc_ci_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/byoc-standards-body-source-snapshot.json", byoc_standards_intake["evidence_item"]["path"])
        self.assertEqual("byoc-self-hosted", byoc_standards_intake["task"]["requirement_id"])
        ...
        self.assertEqual("examples/aitrade/external-evidence/compliance-provider-api-source-snapshot.json", compliance_provider_intake["evidence_item"]["path"])
        self.assertEqual("compliance-mapper-and-eu-ai-act", compliance_provider_intake["task"]["requirement_id"])
        self.assertEqual("provider-api", compliance_provider_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", compliance_provider_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/compliance-provider-api-authority-export.json").read_bytes()).hexdigest(), compliance_provider_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/compliance-regulator-source-snapshot.json", compliance_regulator_intake["evidence_item"]["path"])
        self.assertEqual("compliance-mapper-and-eu-ai-act", compliance_regulator_intake["task"]["requirement_id"])
        self.assertEqual("regulator", compliance_regulator_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", compliance_regulator_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/compliance-regulator-authority-export.json").read_bytes()).hexdigest(), compliance_regulator_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/compliance-standards-body-source-snapshot.json", compliance_standards_intake["evidence_item"]["path"])
        self.assertEqual("compliance-mapper-and-eu-ai-act", compliance_standards_intake["task"]["requirement_id"])
        self.assertEqual("standards-body", compliance_standards_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", compliance_standards_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/compliance-standards-body-authority-export.json").read_bytes()).hexdigest(), compliance_standards_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/trustai-own-compliance-standards-body-source-snapshot.json", own_compliance_standards_intake["evidence_item"]["path"])
        self.assertEqual("trustai-own-compliance", own_compliance_standards_intake["task"]["requirement_id"])
        ...
        self.assertEqual("examples/aitrade/external-evidence/vertical-packs-regulator-source-snapshot.json", vertical_packs_regulator_intake["evidence_item"]["path"])
        self.assertEqual("vertical-packs", vertical_packs_regulator_intake["task"]["requirement_id"])
        self.assertEqual("regulator", vertical_packs_regulator_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", vertical_packs_regulator_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/vertical-packs-regulator-authority-export.json").read_bytes()).hexdigest(), vertical_packs_regulator_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/vertical-packs-insurer-source-snapshot.json", vertical_packs_insurer_intake["evidence_item"]["path"])
        self.assertEqual("vertical-packs", vertical_packs_insurer_intake["task"]["requirement_id"])
        self.assertEqual("insurer", vertical_packs_insurer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", vertical_packs_insurer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/vertical-packs-insurer-authority-export.json").read_bytes()).hexdigest(), vertical_packs_insurer_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/vertical-packs-customer-source-snapshot.json", vertical_packs_customer_intake["evidence_item"]["path"])
        self.assertEqual("vertical-packs", vertical_packs_customer_intake["task"]["requirement_id"])
        self.assertEqual("customer", vertical_packs_customer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", vertical_packs_customer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/vertical-packs-customer-authority-export.json").read_bytes()).hexdigest(), vertical_packs_customer_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-ci-run-source-snapshot.json", insurer_api_ci_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_ci_intake["task"]["requirement_id"])
        ...
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-provider-api-source-snapshot.json", insurer_api_provider_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_provider_intake["task"]["requirement_id"])
        self.assertEqual("provider-api", insurer_api_provider_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", insurer_api_provider_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/insurer-api-and-actuarial-products-provider-api-authority-export.json").read_bytes()).hexdigest(), insurer_api_provider_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-hosted-service-source-snapshot.json", insurer_api_hosted_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_hosted_intake["task"]["requirement_id"])
        self.assertEqual("hosted-service", insurer_api_hosted_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", insurer_api_hosted_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/insurer-api-and-actuarial-products-hosted-service-authority-export.json").read_bytes()).hexdigest(), insurer_api_hosted_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-identity-provider-source-snapshot.json", insurer_api_identity_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_identity_intake["task"]["requirement_id"])
        self.assertEqual("identity-provider", insurer_api_identity_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", insurer_api_identity_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/insurer-api-and-actuarial-products-identity-provider-authority-export.json").read_bytes()).hexdigest(), insurer_api_identity_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-insurer-source-snapshot.json", insurer_api_insurer_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_insurer_intake["task"]["requirement_id"])
        self.assertEqual("insurer", insurer_api_insurer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", insurer_api_insurer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/insurer-api-and-actuarial-products-insurer-authority-export.json").read_bytes()).hexdigest(), insurer_api_insurer_snapshot["body_sha256"])
        self.assertEqual("examples/aitrade/external-evidence/insurer-api-actuarial-customer-source-snapshot.json", insurer_api_customer_intake["evidence_item"]["path"])
        self.assertEqual("insurer-api-and-actuarial-products", insurer_api_customer_intake["task"]["requirement_id"])
        self.assertEqual("customer", insurer_api_customer_intake["task"]["authority_kind"])
        self.assertEqual("file-copy", insurer_api_customer_snapshot["retrieval_method"])
        self.assertEqual("sha256:" + sha256((ROOT / "examples/aitrade/insurer-api-and-actuarial-products-customer-authority-export.json").read_bytes()).hexdigest(), insurer_api_customer_snapshot["body_sha256"])
        ...
        self.assertEqual(
            ["regulator", "insurer", "customer"],
            rebuilt["summary"]["covered_authority_kinds_by_requirement"]["design-partner-pilot-exit-criteria"],
        )
        self.assertEqual(
            ["ci-run", "provider-api", "hosted-service"],
        ...
        self.assertEqual(
            ["kms-hsm", "provider-api", "hosted-service", "identity-provider", "regulator"],
        ...
        self.assertEqual(
            ["provider-api", "regulator", "standards-body"],
