...
class ExternalEvidenceManifestTests(unittest.TestCase):
    ...
    def test_retained_external_evidence_examples_verify(self):
        ...
        self.assertEqual(11, rebuilt["summary"]["covered_authority_kind_count"])
        self.assertEqual(60, rebuilt["summary"]["missing_authority_kind_count"])
        self.assertEqual(retained_manifest["summary"], rebuilt["summary"])
        self.assertEqual(60, remaining_plan["summary"]["selected_task_count"])
        self.assertEqual(60, remaining_plan["summary"]["selected_missing_task_count"])
        self.assertEqual(EXTERNAL_EVIDENCE_SOURCE_MAP_SCHEMA, source_map["schema"])
        self.assertEqual(content_hash(without_keys(source_map, "source_map_id")), source_map["source_map_id"])
        self.assertEqual(60, source_map["summary"]["entry_count"])
        self.assertEqual(60, source_map["summary"]["placeholder_source_uri_count"])
        self.assertEqual(0, source_map["summary"]["live_source_uri_count"])
        ...
        self.assertEqual(11, collected_source_map["summary"]["entry_count"])
        self.assertEqual(0, collected_source_map["summary"]["placeholder_source_uri_count"])
        self.assertEqual(11, collected_source_map["summary"]["live_source_uri_count"])
        ...
        self.assertEqual(11, collection_run["summary"]["collected_count"])
        self.assertEqual(11, collection_run_result.collected_count)
        self.assertEqual(
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(11, collection_payload["collected_count"])
            self.assertEqual(11, collection_payload["task_count"])
            ...
            self.assertEqual(25, collection_bundle["summary"]["source_artifact_count"])
            self.assertEqual(1, collection_bundle["summary"]["external_evidence_collection_run_entry_count"])
            self.assertEqual(25, len(extracted))
            self.assertEqual(
                [
                    "roadmap-audit",
            ...
            missing_source_map_bundle["summary"]["source_artifact_count"] = 24
            ...
            missing_collection_run_bundle["summary"]["source_artifact_count"] = 24
    ...
    def test_cli_external_evidence_gap_report_verifies_retained_worklist(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(11, report["summary"]["covered_authority_kind_count"])
            self.assertEqual(60, report["summary"]["missing_authority_kind_count"])
            self.assertEqual(60, report["summary"]["remaining_task_count"])
            self.assertEqual(60, report["summary"]["source_map_entry_count"])
            self.assertEqual(60, report["summary"]["placeholder_source_uri_count"])
            ...
            self.assertIn("Placeholder source URIs: 60", markdown)
            self.assertIn("- Description: provider-api evidence for self-serve-onboarding", markdown)

            tampered = copy.deepcopy(report)
            tampered["summary"]["remaining_task_count"] = 59
