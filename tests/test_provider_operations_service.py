...
class ProviderOperationsServiceTests(unittest.TestCase):
    def _sources(self) -> dict:
        return {
            ...
            "callback_store_source_artifacts": [
                _load("artifacts/github-provider-installation.json"),
                _load("artifacts/github-provider-webhook.json"),
                _load("artifacts/github-check-run-delivery.json"),
                _load("artifacts/github-provider-audit-correlation.json"),
                _load("artifacts/provider-audit-stream.json"),
            ],
    ...
    def test_cli_provider_operations_service_round_trip(self):
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            sources = [
                ...
                "artifacts/github-provider-installation.json",
                "--callback-store-artifact",
                "artifacts/github-provider-webhook.json",
                "--callback-store-artifact",
