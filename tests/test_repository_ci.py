...
class RepositoryCiTests(unittest.TestCase):
    ...
    def test_public_repo_has_python_and_go_ci_workflows(self):
        ...
        self.assertIn("retained-external-evidence-production-replacement-remediation-owner-fulfillment-template.csv", script)
    ...
    def test_retained_evidence_and_ci_counts_match_manifest(self):
        ...
        self.assertEqual("blocked", production_remediation_owner_fulfillment_review_summary["review_status"])
    ...
    def test_external_evidence_spec_documents_production_replacement_lifecycle(self):
        ...
        self.assertIn("--csv", spec)
        self.assertIn("--fulfillment-csv-file", spec)
        self.assertIn("--filled-template-out", spec)
        self.assertIn("spreadsheet-friendly owner work queue", spec)
