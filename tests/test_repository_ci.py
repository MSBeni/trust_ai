...
class RepositoryCiTests(unittest.TestCase):
    def test_python_ci_bootstraps_artifacts_before_smoke_tests(self):
        ...
        self.assertIn("python -m trustai external-evidence-append artifacts/external-evidence-manifest.json", workflow)
        ...
        self.assertIn("--source-artifact \"external-evidence-file,examples/aitrade/external-evidence/go-verifier-workflow-run.json,Recorded Go verifier workflow export\"", workflow)
