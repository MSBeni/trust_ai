...
class RepositoryCiTests(unittest.TestCase):
    def test_python_ci_bootstraps_artifacts_before_smoke_tests(self):
        ...
        self.assertIn("python -m trustai external-evidence-snapshot https://github.com/MSBeni/trust_ai/actions", workflow)
        ...
        self.assertIn("--artifact artifacts/external-evidence-source-snapshot.json", workflow)
