...
CONFORMANCE_TARGETS = (
    ...
    },
    {
        ...
        "description": "Temporal holdout manifests, traffic holdout exports, and completeness receipts bind retained replay source bytes, production traffic source refs, extraction windows, replay record hashes, collector/provider stream records, retained provider export byte replay, cursor bounds, audit records, freeze and holdout boundaries, production-claim status, privacy limits, and chain append evidence before shadow replay promotion evidence is trusted.",
