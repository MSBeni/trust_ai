...
CONFORMANCE_TARGETS = (
    ...
    },
    {
        ...
        "description": "Verifier public release authority dossiers bind signed verifier public release receipts to provider workflow, release API, artifact manifest, SBOM/provenance/signature, transparency-log, audit-log, credential-custody, per-evidence public release source context, freshness, retained provider workflow export replay, and production-claim evidence.",
