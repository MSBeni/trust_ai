...
REQUIRED_SPEC_PATHS = (
    ...
    "docs/specs/promotion-status-review-bundle-v0.1.md",
...
CONFORMANCE_TARGETS = (
    ...
    },
    {
        ...
        "description": "Temporal holdout manifests, traffic holdout exports, completeness receipts, and shadow replay review bundles bind retained replay source bytes, production traffic source refs, extraction windows, replay record hashes, collector/provider stream records, retained provider export byte replay, cursor bounds, audit records, freeze and holdout boundaries, production-claim status, privacy limits, optional re-execution and soak-demotion source replay, and chain append evidence before shadow replay promotion evidence is trusted.",
        "reference": "src/trustai/shadow.py",
        "commands": [
            "python -m trustai temporal-holdout-manifest examples/aitrade/verification-contract.yaml examples/aitrade/shadow-replay.json --generated-at 2026-07-03T12:10:00Z --out artifacts/temporal-holdout-manifest.json",
            ...
            "python -m trustai shadow-replay-review-bundle examples/aitrade/verification-contract.yaml examples/aitrade/shadow-replay.json artifacts/temporal-holdout-manifest.json artifacts/traffic-holdout-export.json artifacts/traffic-completeness.json examples/aitrade/traffic-completeness-provider-export.json --reviewer-ref auditor:model-risk --bundle-ref shadow-review:aitrade/20260703 --out artifacts/shadow-replay-review-bundle.json --markdown artifacts/shadow-replay-review-bundle.md",
            "python -m trustai shadow-replay-review-bundle-verify artifacts/shadow-replay-review-bundle.json",
            "python -m trustai shadow-replay-review-bundle-extract artifacts/shadow-replay-review-bundle.json --out-dir artifacts/shadow-replay-review-bundle-sources",
            "python -m trustai shadow-replay-review-bundle-append artifacts/shadow-replay-review-bundle.json --state .trustai/shadow-replay-review-demo/evidence-chain.json --tenant shadow-replay-review-local --out artifacts/shadow-replay-review-bundle-entry.json",
            "python -m unittest tests.test_temporal_holdout",
            "python -m unittest tests.test_shadow_replay_review_bundle",
        ],
    },
    {
    ...
    },
    {
        ...
        "description": "Framework adapter production authority dossiers bind adapter matrices, native hook releases, optional runtime service authority, compatibility evidence, per-evidence source context, freshness windows, and production-claim limits for maintained native framework hooks.",
    ...
    },
    {
        ...
        "description": "MCP proxy capture receipts bind raw MCP JSON-RPC tools/call request/response envelopes, retained source export byte replay, stdio client message artifact replay, upstream stdout response artifact replay, and verifier-recomputed redaction summaries to redacted event hash chains, derived normalized tool-call transcripts, signed capture ids, and chain append evidence.",
    ...
    },
    {
        ...
        "description": "Verifier public release authority dossiers bind signed verifier public release receipts to provider workflow, release API, artifact manifest, SBOM/provenance/signature, transparency-log, audit-log, credential-custody, per-evidence public release source context, freshness, retained OSS verifier CI authority export replay, and production-claim evidence.",
        "reference": "src/trustai/verifier_release_authority.py",
        "commands": [
            "python -m trustai verifier-release-authority artifacts/verifier-public-release.json artifacts/verifier-release.json artifacts/verifier-distribution.json artifacts/go-verifier-build-attestation.json artifacts/go-verifier-release-run.json artifacts/go-verifier-release-run-bundle.json --conformance-report artifacts/verifier-conformance.json --standards-package artifacts/standards-submission.json --root . --distribution-bundle artifacts/verifier-source-bundle.zip --distribution-sbom artifacts/verifier-source-sbom.json --distribution-provenance artifacts/verifier-source-provenance.json --distribution-signature artifacts/verifier-source-signature.json --binary dist/trustai-verify-linux-amd64 --environment release-prod --dossier-ref dossier:verifier-release-authority/v0.1.0 --authority-ref authority:verifier-release/github/v0.1.0 --producer-ref oidc:trustai.example/verifier-release-authority-worker --authority-evidence 'completed-provider-workflow-run,ci-run,github-actions-run:1234567890,sha256:de47edc2b2bba6ebb9e49f8b0c612effd57e971e6ecc3886a7ca0f9ae978e53b,OSS verifier CI authority export;issuer=GitHub Actions;subject=trustai verifier release v0.1.0;source_uri=https://github.com/MSBeni/trust_ai/actions/runs/1234567890;issued_at=2026-07-16T00:10:00Z;expires_at=2026-07-23T00:10:00Z' --authority-artifact 'completed-provider-workflow-run,examples/aitrade/oss-verifier-ci-run-authority-export.json' --generated-at 2026-07-16T00:12:00Z",
    ...
    },
    {
        ...
        "description": "Provider delivery service attestations bind provider delivery receipts, retained payload artifact replay, and retained response artifact bindings to dispatch worker fleet, queue, DLQ, retry, idempotency, outbound proxy, provider endpoint, egress, rate limits, request signing, audit, metrics, actor, redacted credentials, and optional provider operations service evidence.",
    ...
    },
    {
        ...
        "description": "Policy backend production authority dossiers bind signed authority evidence bundles, provider export bundles, and optional service review bundles to external OPA/Cedar backend authority evidence, live source URIs, per-evidence source context, freshness windows, missing requirement coverage, derived controls, and chain-backed production-claim limits.",
        "reference": "src/trustai/policy_backend_authority.py",
        "commands": [
            "python -m trustai policy-backend-authority-evidence-bundle --mode authority-export --environment aitrade-prod --bundle-ref bundle:policy-backend-authority/lg-trace-001 --issuer-ref oidc:trustai.example/policy-backend-authority-exporter --subject-ref service:policy-backend/aitrade-prod --authority-ref authority:policy-backend/aitrade-prod --authority-evidence \"opa-cedar-backend-fleet,hosted-service,service:policy-backend-fleet/aitrade-prod,sha256:361f39efd062de14d2eb6fba49c01658e35c5a21c46a524f6f380d03f273891d,Hosted OPA/Cedar backend fleet deployment export;issuer=TrustAI Cloud;subject=aitrade-prod policy backend fleet;source_uri=https://ops.example/trustai/policy-backend/aitrade-prod;issued_at=2026-07-04T00:00:00Z;expires_at=2026-07-11T00:00:00Z\" --generated-at 2026-07-04T05:18:00Z --out artifacts/policy-backend-authority-evidence-bundle.json",
    ...
    },
    {
        ...
        "commands": [
            "python -m trustai insurer-partner-authority artifacts/insurer-partner-service-attestation.json --worker artifacts/insurer-partner-worker.json --worker-bundle artifacts/insurer-partner-worker-bundle.json --environment aitrade-prod --dossier-ref dossier:insurer-partner-authority/underwriter-prod --authority-ref authority:insurer-partner/underwriter-prod --producer-ref oidc:trustai.example/insurer-partner-authority-worker --authority-evidence \"credentialed-partner-api-calls,insurer,insurer:underwriter/api/aitrade,sha256:aa846863e8393f95aa19e9b75ab62d3fb0f02bd50350f70a210fe16bd5a774a0,Live underwriter API authority export;issuer=Example AI Liability Underwriter;subject=aitrade-prod insurer partner API;source_uri=https://underwriter.example/audit/trustai/aitrade;issued_at=2026-07-08T06:20:00Z;expires_at=2026-07-15T06:20:00Z\" --generated-at 2026-07-08T06:25:00Z --out artifacts/insurer-partner-authority.json",
    ...
    },
    {
        ...
        "description": "Review portal production authority dossiers and evidence bundles bind review portal service attestations to external hosted UI/session/account/access-log authority evidence, freshness windows, live source URI coverage, missing coverage, and production-claim limits.",
    ...
    },
    {
        ...
        "description": "Trust-network production authority dossiers bind hosted trust-network service attestations, worker receipts, optional worker review bundles, per-evidence source_context, embedded source-artifact roots, marketplace asset/frontend replay status, and external hosted registry, marketplace, identity-provider, lifecycle-worker, settlement, revocation, callback, and observability authority evidence to freshness windows, missing coverage, and production-claim limits.",
    ...
    *,
    ...
    body = {
        ...
        "submission_checklist": [
            ...
            "Publish promotion status review bundle format for offline CI/CD gate evidence review.",
